...
grid_search = {
    ...
    'GBF3_NVIS_NRM_SELECTED_REGIONS': [['North East', 'Goulburn Broken']],  # Only used when mode = 'NRM_SEL_REGIONS'
    'GBF4_SNES_NRM_REGION_MODE': ['Australia'],                             # 'Australia' or 'NRM_SEL_REGIONS'
    'GBF4_SNES_NRM_SELECTED_REGIONS': [['North East', 'Goulburn Broken']],  # Only used when mode = 'NRM_SEL_REGIONS'
    'GBF4_ECNES_NRM_REGION_MODE': ['Australia'],                            # 'Australia' or 'NRM_SEL_REGIONS'
    'GBF4_ECNES_NRM_SELECTED_REGIONS': [['North East', 'Goulburn Broken']], # Only used when mode = 'NRM_SEL_REGIONS'
